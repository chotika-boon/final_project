...
ร้าน: {r['name']}
ด้านล่างนี้คือข้อมูลโปรโมชั่นของร้านนี้ที่รองรับบัตรเครดิตหลายประเภท โดยมีคอลัมน์สำคัญ:
- Card_name: ชื่อบัตร
- amount: ยอดขั้นต่ำที่ใช้เพื่อรับสิทธิ์
...
1. **จัดกลุ่มบัตร** เป็น:
   - ✅ บัตรที่ผู้ใช้มี
   - 💳 บัตรที่ผู้ใช้ไม่มี
2. **เรียงลำดับบัตรจากแต่ละกลุ่ม** โดยพิจารณาจาก:
...
3. **ช่วยระบุว่าแต่ละโปรโมชั่นเหมาะกับ**:
   - กินคนเดียว
   - กินเป็นกลุ่ม
